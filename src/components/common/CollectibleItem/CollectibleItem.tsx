        ...
        <>
            <a className='collectible' onClick={clickItem}>
                ...
                <div className='collectible__body'>
                    ...
                    <span>by <a className='collectible__body__link'> jhondoe.near</a></span>
                </div>
                <img className='collectible__chevron' src="./assets/chevron-r-black.svg" alt="" />
